...
const adminNav = [
  ...
  { name: 'Transactions', path: '/admin/transactions', icon: 'CurrencyDollar' },
  { name: 'Content Moderation', path: '/admin/content', icon: 'ShieldCheck' },
  { name: 'Content Management', path: '/admin/content-management', icon: 'DocumentText' },
  { name: 'Analytics', path: '/admin/analytics', icon: 'ChartPie' },
  { name: 'Support', path: '/admin/support', icon: 'Lifebuoy' },
  { name: 'Logs', path: '/admin/logs', icon: 'ClipboardList' },
  { name: 'Settings', path: '/admin/settings', icon: 'Cog' },
];

// Heroicons v1 (outline version)
const icons = {
  ChartBar: (
